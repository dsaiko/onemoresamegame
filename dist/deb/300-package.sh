...
then
	DIST_DEPENDS="qml-module-qtquick-controls (>=5.2.1), qml-module-qtquick-particles2 (>=5.2.1), qml-module-qtquick-localstorage (>=5.2.1)"
else
	DIST_DEPENDS="qtdeclarative5-controls-plugin (>=5.2.1), qtdeclarative5-particles-plugin (>=5.2.1), qtdeclarative5-localstorage-plugin (>=5.2.1)"
fi
